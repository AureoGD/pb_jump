...
OptProblem2::OptProblem2(JumpRobot *Robot) : RobotKin(Robot)
{
...
OptProblem2::~OptProblem2()
{
}

void OptProblem2::UpdateModelConstants()
{
    /*
    x = | dr q r -g|   u = qr
...
void OptProblem2::UpdateDynamicModel()
{
